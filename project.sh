...
##    docker compose run --rm node packages/formatero/bin/main.js
##    docker compose run --rm node packages/lintero/bin/main.js
##    docker compose run --rm node packages/monorepo/bin/main.js
    docker compose run --rm node packages/read-it/bin/main.js
##    docker compose run --rm node packages/ship-it/bin/main.js
##    docker compose run --rm node packages/tag-it/bin/main.js
##    docker compose run --rm node packages/testero/bin/main.js
##  docker compose run --rm node packages/zip-it/bin/main.js
