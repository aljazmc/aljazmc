...
##    docker compose run --rm node yarn monorepo
    docker compose run --rm node yarn read-it
##    docker compose run --rm node yarn ship-it
##    docker compose run --rm node yarn tag-it
##    docker compose run --rm node yarn testero
##    docker compose run --rm node yarn zip-it
